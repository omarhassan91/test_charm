...
find_path(MKL_ROOT_DIR
  NAMES include/fftw/fftw3.f
  PATHS $ENV{MKLROOT} $ENV{MKL_HOME})
...
find_path(MKL_INCLUDE_DIR
  NAMES fftw/fftw3.f
  HINTS ${MKL_ROOT_DIR} $ENV{MKL_HOME} $ENV{MKLROOT}
  PATH_SUFFIXES include)

# set arguments to call the MKL provided tool for linking

# check that the tools exists
set(HAS_MLT TRUE)
find_program(MKL_LINK_TOOL
  NAMES mkl_link_tool mkl_link_tool.exe
  PATHS ${MKL_ROOT_DIR}
  PATH_SUFFIXES tools)
...
if(NOT HAS_MLT)
  find_path(MKL_LIBRARY_DIR
    NAMES libmkl_core.dylib libmkl_core.so libmkl_core.a
    HINTS ${MKL_ROOT_DIR} $ENV{MKL_HOME} $ENV{MKLROOT}
    PATH_SUFFIXES lib lib/intel64 lib/em64t)
...
#     endif()
    ...
    if(CMAKE_Fortran_COMPILER_ID STREQUAL "Intel")
        list(APPEND MKL_LINK_TOOL_COMMAND "--compiler=intel_f")
    elseif(CMAKE_Fortran_COMPILER_ID MATCHES "PGI")
        list(APPEND MKL_LINK_TOOL_COMMAND "--compiler=pgi_f")
    else()
        list(APPEND MKL_LINK_TOOL_COMMAND "--compiler=gnu_f")
    endif()
...
mark_as_advanced(MKL_INCLUDE_DIR MKL_LIBRARY_DIR MKL_LIBRARIES MKL_ROOT_DIR)
